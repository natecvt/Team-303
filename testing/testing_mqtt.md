...
3. Run the command-line publisher with `mosquitto_pub -t "test/topic" -V mqttv5 -f msgs/print_complete.json`. This should publish the specified file's contents once. This file's contents should appear on the terminal.
